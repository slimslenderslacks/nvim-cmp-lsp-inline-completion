...
local _2amodule_name_2a = "nvim-cmp-lsp-inline-completion.aniseed.fs"
local _2amodule_2a
do
...
local a, nvim = autoload("nvim-cmp-lsp-inline-completion.aniseed.core"), autoload("nvim-cmp-lsp-inline-completion.aniseed.nvim")
