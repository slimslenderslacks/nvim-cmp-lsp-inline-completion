...
local _2amodule_name_2a = "nvim-cmp-lsp-inline-completion.aniseed.fennel"
local _2amodule_2a
do
...
local autoload = (require("nvim-cmp-lsp-inline-completion.aniseed.autoload")).autoload
local a, fs, nvim, str = autoload("nvim-cmp-lsp-inline-completion.aniseed.core"), autoload("nvim-cmp-lsp-inline-completion.aniseed.fs"), autoload("nvim-cmp-lsp-inline-completion.aniseed.nvim"), autoload("nvim-cmp-lsp-inline-completion.aniseed.string")
...
local function impl()
  local compiler = require("nvim-cmp-lsp-inline-completion.aniseed.deps.fennel")
