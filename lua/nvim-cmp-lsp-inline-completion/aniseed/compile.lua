...
local _2amodule_name_2a = "nvim-cmp-lsp-inline-completion.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-cmp-lsp-inline-completion.aniseed.core"), autoload("nvim-cmp-lsp-inline-completion.aniseed.fennel"), autoload("nvim-cmp-lsp-inline-completion.aniseed.fs"), autoload("nvim-cmp-lsp-inline-completion.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "nvim-cmp-lsp-inline-completion.aniseed.macros"
  local filename
  do
