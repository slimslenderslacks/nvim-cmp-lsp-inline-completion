...
local _2amodule_name_2a = "nvim-cmp-lsp-inline-completion.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-cmp-lsp-inline-completion.aniseed.core"), autoload("nvim-cmp-lsp-inline-completion.aniseed.compile"), autoload("nvim-cmp-lsp-inline-completion.aniseed.fennel"), autoload("nvim-cmp-lsp-inline-completion.aniseed.fs"), autoload("nvim-cmp-lsp-inline-completion.aniseed.nvim")
