...
local _2amodule_name_2a = "nvim-cmp-lsp-inline-completion.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-cmp-lsp-inline-completion.aniseed.core"), autoload("nvim-cmp-lsp-inline-completion.aniseed.env"), autoload("nvim-cmp-lsp-inline-completion.aniseed.eval"), autoload("nvim-cmp-lsp-inline-completion.aniseed.nvim")
