...
compile:
	...
	deps/aniseed/scripts/embed.sh aniseed nvim-cmp-lsp-inline-completion

	# Also remove this embed prefix if you're not using Aniseed inside your plugin at runtime.
	ANISEED_EMBED_PREFIX=nvim-cmp-lsp-inline-completion deps/aniseed/scripts/compile.sh
